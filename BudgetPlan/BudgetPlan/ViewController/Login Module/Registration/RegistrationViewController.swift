...
class RegistrationViewController: UIViewController {
    ...
    //Switch
    @IBOutlet weak var switch_TouchId: UISwitch!
    ...
    func commanMethod(){
        ...
        switch_TouchId.layer.cornerRadius = 15
           ...
           vw_Notification.isHidden = false
            ...
            if boolEmail == true && boolPassword == true{
                self.view.endEditing(true)
                    messageBar.MessageShow(title: "You've registered successfully", alertType: MessageView.Layout.cardView, alertTheme: .success, TopBottom: true)

                    self.performSegue(withIdentifier: "createaccount", sender: self)
                
                //Store data in object
                let obj = UserDataObject(str_Email: tf_Email.text!,
                                         str_TouchId: (switch_TouchId.isOn == true) ? "1" : "0",
                                         str_Password: "1234",
                                         str_UserName: "")
